// Sprite-atlas animation config + UV math. Single source of truth, imported by
// both the renderer (app.js, over peon-asset://) and the headless test suite
// (tests/anim-state.test.ts) — plain ESM JS so both sides can load it.
 ...
 */
export function computeUVs(animName, frame) {
